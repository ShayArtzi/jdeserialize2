...
public class ClassDesc extends ContentBase {
     ...
     */
    public ClassDescTypeEnum classtype;
    ...
    public String toString() {
        ...
        sb.append("[cd ").append(FormatUtil.hex(handle)).append(": name ").append(name);
    ...
    public void getHierarchy(ArrayList<ClassDesc> classes) {
        if(superclass != null) {
            if(superclass.classtype == ClassDescTypeEnum.PROXYCLASS) {
            	LogUtil.debugerr("warning: hit a proxy class in superclass hierarchy");
            } else {
